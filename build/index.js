...
var SortableMultiValue = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__["SortableElement"])(function (props) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_2__["createElement"])(react_select__WEBPACK_IMPORTED_MODULE_3__["components"].MultiValue, _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_1___default()({}, props, {
    innerProps: innerProps
  }));
});
var SortableSelect = Object(react_sortable_hoc__WEBPACK_IMPORTED_MODULE_4__["SortableContainer"])(react_select__WEBPACK_IMPORTED_MODULE_3__["default"]);
var ControlField = withSelect(function (select, _ref) {
  ...
  if (typeof row_index === 'undefined') {
    var _defaultValue = Array.isArray(values) ? values.map(function (item) {
      var _show_in_rest$schema, _show_in_rest$schema$;

      var arrayItemProperties = show_in_rest === null || show_in_rest === void 0 ? void 0 : (_show_in_rest$schema = show_in_rest.schema) === null || _show_in_rest$schema === void 0 ? void 0 : (_show_in_rest$schema$ = _show_in_rest$schema.items) === null || _show_in_rest$schema$ === void 0 ? void 0 : _show_in_rest$schema$.properties;
  ...
  var defaultValue = values[row_index] && Array.isArray(values[row_index][property_key]) ? values[row_index][property_key].map(function (option) {
    var labelOption = options.find(function (propOption) {
...
ControlField = withDispatch(function (dispatch, _ref2) {
  var _ref2$field = _ref2.field,
      meta_key = _ref2$field.meta_key,
      show_in_rest = _ref2$field.show_in_rest,
  ...
  return {
    onChange: function onChange(value) {
      ...
      if (typeof row_index !== 'undefined') {
        ...
        var _show_in_rest$schema2, _show_in_rest$schema3;

        var arrayItemProperties = show_in_rest === null || show_in_rest === void 0 ? void 0 : (_show_in_rest$schema2 = show_in_rest.schema) === null || _show_in_rest$schema2 === void 0 ? void 0 : (_show_in_rest$schema3 = _show_in_rest$schema2.items) === null || _show_in_rest$schema3 === void 0 ? void 0 : _show_in_rest$schema3.properties;
        var arrayItemKey = Object.keys(arrayItemProperties)[0];
    ...
    onSortEnd: function onSortEnd(_ref4) {
      ...
      var values = (_select$getEditedPost2 = select('core/editor').getEditedPostAttribute('meta')) === null || _select$getEditedPost2 === void 0 ? void 0 : _select$getEditedPost2[meta_key];
      var newValues = Object(_utils__WEBPACK_IMPORTED_MODULE_5__["arrayMove"])(values, oldIndex, newIndex);
      dispatch('core/editor').editPost({
...
var InnerControlComponent = function InnerControlComponent(props) {
  ...
  var ControlField = _controlsIndex__WEBPACK_IMPORTED_MODULE_2__["default"][controlFieldKey];
...
/* harmony import */ var _Mulitselect__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Mulitselect */ "./src/Mulitselect.js");
...
var controlsIndex = {
  ...
  multiselect: _Mulitselect__WEBPACK_IMPORTED_MODULE_6__["default"]
};
